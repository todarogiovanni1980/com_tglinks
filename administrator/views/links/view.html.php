...
/**
 * View class for a list of Tglinks.
 *
 * @since  1.6
 */
class TglinksViewLinks extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		TglinksHelper::addSubmenu('links');
	...
	protected function addToolbar()
	{
		...
		$canDo = TglinksHelper::getActions();

		JToolBarHelper::title(Text::_('COM_TGLINKS_TITLE_LINKS'), 'links.png');
		...
		{
			JToolBarHelper::preferences('com_tglinks');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_tglinks&view=links');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_TGLINKS_LINKS_TITLE'),
		);
	}
