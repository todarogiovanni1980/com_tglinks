...
/**
 * Methods supporting a list of Tglinks records.
 *
 * @since  1.6
 */
class TglinksModelLinks extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_tglinks'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_TGLINKS_SEARCH_FILTER_DATE_FORMAT"), "warning");
