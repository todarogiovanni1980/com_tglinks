...
JLoader::registerPrefix('Tglinks', JPATH_SITE . '/components/com_tglinks/');
 ...
 * @since  3.3
 */
class TglinksRouter extends \Joomla\CMS\Component\Router\RouterBase
{
	/**
	...
	public function parse(&$segments)
	{
		...
		$model        = TglinksHelpersTglinks::getModel($vars['view']);
