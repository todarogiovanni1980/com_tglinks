 ...
 * @since  1.6
 */
class TglinksViewLink extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$this->params = $app->getParams('com_tglinks');
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', Text::_('COM_TGLINKS_DEFAULT_PAGE_TITLE'));
		}
